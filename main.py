...
You're running SkyPanel without specifying {click.style('UVICORN_SSL_CERTFILE', italic=True, fg="magenta")} and {click.style('UVICORN_SSL_KEYFILE', italic=True, fg="magenta")}.
The application will only be accessible through localhost. This means that {click.style('SkyPanel and subscription URLs will not be accessible externally', bold=True)}.
